...
<p class="prose-text"><strong>English.</strong> After file uploads (1 Oct), this post covers CDN/edge caching: why PoPs exist, Cache-Control, HTML vs fingerprinted assets, purge, Vary/privacy, TLS, origin shield, metrics and deploy interactions.</p>

...
<aside class="chapter-header" aria-label="Section introduction">
  ...
  <p class="chapter-theme"><strong>Theme:</strong> The biographical and historical milestones, tracing the trajectory from revolutionary uprisings and the authorship of the १८५७ (1857) historical treatise to the harrowing incarceration in the अण्डमान (Andaman) archipelago.</p>
...
<aside class="chapter-header" aria-label="Section introduction">
  ...
  <p class="chapter-theme"><strong>Theme:</strong> The unprecedented poetic contributions composed during penal servitude, entirely without writing instruments, including epics and lyrics such as कमला, गोमन्तक and जयोस्तुते.</p>
</aside>
...
<aside class="chapter-header" aria-label="Section introduction">
  ...
  <p class="chapter-theme"><strong>Theme:</strong> The comprehensive linguistic purification movement aimed at decolonizing the vernacular by purging it of foreign vocabulary (Perso-Arabic and English) and reviving or forging Sanskrit-derived neologisms based on the धातुपाठ (root catalog).</p>
</aside>
...
<aside class="chapter-header" aria-label="Section introduction">
  ...
  <p class="chapter-theme"><strong>Theme:</strong> The philosophical tenets encompassing rationalism, the eradication of caste hierarchies and the reinterpretation of ethical warfare derived from the भगवद्गीता.</p>
</aside>
